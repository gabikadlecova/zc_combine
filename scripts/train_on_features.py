...
from zc_combine.utils.script_utils import load_feature_proxy_dataset, get_data_splits, eval_model, \
    create_cache_filename, get_wl_embedding, normalize_columns, get_data_splits_ta_gates
...
def train_and_eval(args):
    ...
    for i_seed in range(args['n_train_samples']):
        ...
        if args['ta_gates_train'] is None:
            ...
            data_splits = get_data_splits_ta_gates(dataset, y, nets=net_data['nets'], train=args['ta_gates_train'],
